"Изменения в файлах стилей и некоторых файлах изначально не предусмотренных выполнением ПР обусловленны рекомендацией наставника по улучшению стартового набора.
Основные изменения относящиеся к выполнению ПР находятся в файлах:
